...
class SngcFacturePam(models.Model):
    ...
    doit = fields.Char("Doit :", default='Programme Alimentaire Mondial (PAM)', required=True, states={'V': [('readonly', True)]})
...
class SngcFacturePamLine(models.Model):
    ...
    qte = fields.Float("Quantité",digits=(12,3), required=True)
    prix = fields.Float("Prix unitaire", required=True)
    prix_manut = fields.Float("Prix unitaire")
    manut_total = fields.Float("Montant", digits=(12,3), store=True, compute='_calcul_manut')
    montant = fields.Float("Prix Total", digits=(12,3), store=True, compute='_calcul')
